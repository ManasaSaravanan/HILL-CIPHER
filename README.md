...
int main() {
  char msg[] = "MANASA", enc[100], dec[100];
  hill(msg, enc, 1); printf("Encrypted: %s\n", enc);
  hill(enc, dec, 0); printf("Decrypted: %s\n", dec);
}
~~~
## OUTPUT
<img width="1539" height="973" alt="Screenshot 2025-09-03 101300" src="https://github.com/user-attachments/assets/f4180fe6-21cd-42d1-9b16-e32e4f15d847" />
